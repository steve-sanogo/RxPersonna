...
# --- CONFIGURATION ---
# Utilisation du nouveau fichier généré avec la polarité
CSV_PATH = "./data/outputs/submission_finale_with_polarity.csv"
IMAGES_PATH = "./data/images"

# Map de couleurs pour les labels de polarité
POLARITY_COLORS = {
    "ami": "#27ae60",  # Vert foncé
    "plutot_ami": "#a9dfbf",  # Vert clair
    "neutre": "#bdc3c7",  # Gris
    "plutot_ennemi": "#f5b7b1",  # Rouge clair
    "ennemi": "#c0392b"  # Rouge foncé
}
